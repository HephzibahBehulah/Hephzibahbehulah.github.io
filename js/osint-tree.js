        ...
        // ========================================
        {
            ...
            children: [
                ...
                },
                {
                    ...
                    icon: '🕵️',
                    description: 'Interactive map of open-source intelligence tools.',
                ...
                },
                {
                    ...
                    icon: '📚',
                    badge: 'R',
                    description: 'Free and premium cybersecurity courses.',
                ...
                },
                {
                    ...
                    name: 'VulnHub',
                    icon: '💿',
                    description: 'Vulnerable virtual machines for practice.',
                ...
                },
                {
                    ...
                    name: 'CTF Time',
                    icon: '🏁',
                    description: 'Global CTF competition calendar and rankings.',
            ...
            children: [
                {
                    ...
                    icon: '🏆',
                    badge: 'R',
                    description: 'Datasets, competitions, and ML notebooks.',
                ...
                },
                {
                    ...
                    name: 'Google Colab',
                    icon: '📓',
                    description: 'Free cloud-based Python notebooks with GPU.',
                ...
                },
                {
                    ...
                    name: 'BigQuery',
                    icon: '📊',
                    description: 'Serverless data warehouse from Google Cloud.',
                ...
                },
                {
                    ...
                    name: 'Database Star',
                    icon: '⭐',
                    description: 'Free datasets for data science projects.',
                    url: 'https://database.star',
                    category: 'data'
                }
            ]
        },
            ...
            children: [
                {
                    ...
                    icon: '⚡',
                    description: 'Free electrical engineering textbooks and resources.',
                ...
                },
                {
                    ...
                    icon: '🔌',
                    description: 'Electronics tutorials and circuit theory.',
                ...
                },
                {
                    ...
                    icon: '🔋',
                    description: 'Electronic components and reference designs.',
                    url: 'https://ti.com',
                    category: 'electrical'
                },
                {
            ...
            children: [
                {
                    ...
                    icon: '✈️',
                    description: 'Airbus aircraft and aerospace technology.',
                ...
                },
                {
                    ...
                    name: 'FAA Resources',
                    icon: '🛫',
                    description: 'Federal Aviation Administration resources.',
                    url: 'https://faa.gov',
                    category: 'aviation'
                },
                {
                    ...
                    name: 'SKYbrary',
                    icon: '📚',
                    description: 'Aviation safety knowledge base.',
                ...
                },
                {
                    ...
                    name: 'FlightGlobal',
                    icon: '🌍',
                    description: 'Aviation news and industry insights.',
            ...
            children: [
                {
                    ...
                    name: 'Open Library',
                    icon: '📚',
                    description: 'Millions of free eBooks from the Internet Archive.',
                ...
                },
                {
                    ...
                    icon: '📖',
                    description: 'Over 60,000 free classic eBooks.',
                ...
                },
                {
                    ...
                    name: 'PDF Drive',
                    icon: '📕',
                    description: 'Free PDF eBooks for download.',
                ...
                },
                {
                    ...
                    name: 'GenZ Bible',
                    icon: '📖',
                    description: 'Modern Bible reading platform for youth.',
                    url: 'https://genz-bible.com',
                    category: 'learning'
                },
                {
                    id: 'biblegateway',
                    name: 'Bible Gateway',
                    icon: '📜',
                    description: 'Read and search the Bible in multiple versions.',
            ...
            children: [
                {
                    ...
                    name: 'Cisco',
                    icon: '🌐',
                    description: 'Networking hardware and certifications.',
                    url: 'https://cisco.com',
                    category: 'tools'
                },
                {
        ...
        // ========================================
        {
            ...
            children: [
                ...
                },
                {
                    ...
                    name: 'IoT For All',
                    icon: '📶',
                    description: 'IoT news, articles, and resources.',
                    url: 'https://iotforall.com',
                    category: 'tools'
                },
                {
                    id: 'eclipse-iot',
                    name: 'Eclipse IoT',
                    icon: '🌐',
                    description: 'Open-source IoT projects and tools.',
